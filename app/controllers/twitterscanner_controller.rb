  ...
  def process_request
    begin
      ...
      if tweets
        ...
        tweet_at_user = "@#{user_tweet_data[:user_name]} Top 3 emojis & their associated sentiment for #{user_tweet_data[:hashtag]}: #{tweets[0][0][0]}=#{sentiments[0]} #{tweets[1][0][0]}=#{sentiments[1]} #{tweets[2][0][0]}=#{sentiments[2]} | More info @ http://bit.ly/1qBqqJv"
